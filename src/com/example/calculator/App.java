...
public class App {
    ...
    public static void main(String[] args) {
        ...
        try {
            while (true) {
                ...
                while(true) {
                    ...
                    switch(functionScan) {
                        ...
                        case "s":
                            ...
                            Number searchNum = parseStringToNumber(sc.next());
                ...
                System.out.println("\n첫 번째 숫자를 입력하세요.");
                Number firstNum = parseStringToNumber(sc.next());

                System.out.println("두 번째 숫자를 입력하세요.");
                Number secondNum = parseStringToNumber(sc.next());
            ...
            System.out.println("숫자를 입력해주세요!! 계산기를 종료합니다.");
        }
    }
    ...
    public static Number parseStringToNumber(String number) throws NumberFormatException {
        if(number.contains(".")){
